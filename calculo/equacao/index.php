    ...
    <div id="vue">
        ...
        <form action="" method="post" class="form-inline">
            <div class="form-group">
                <input type="text" class="form-control" placeholder="Informe o valor de a" maxlength="2" name="a" v-model="a">
            </div>
            <div class="form-group">
                <input type="text" class="form-control" placeholder="Informe o valor de b" maxlength="2" name="b" v-model="b">
            </div>
            <div class="form-group">
                <input type="text" class="form-control" placeholder="Informe o valor de c" maxlength="2" name="c" v-model="c">
            </div>
